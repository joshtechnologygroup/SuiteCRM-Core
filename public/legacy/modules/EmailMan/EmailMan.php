        ...
        if (
            ...
            if ($text_only) {
                ...
                if ($this->has_optout_links == false) {
                    $mail->Body .= "
                  <div style='background:#f6f6f6;background-color:#f6f6f6;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f6f6f6;background-color:#f6f6f6;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#f6f6f6'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;padding:16px 16px 12px;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='margin:0px auto;max-width:568px;font-family:Arial,Helvetica,sans-serif'><font style='font-size:0.6em; color: #888; padding: 20px;'>{$mod_strings['TXT_REMOVE_ME']} <a href='" . $this->tracking_url . "index.php?entryPoint=removeme&identifier={$this->getTargetId()}'>{$mod_strings['TXT_REMOVE_ME_CLICK']}</a></font></div></td></tr></tbody></table></div>
                  ";
                }
