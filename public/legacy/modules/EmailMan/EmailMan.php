...
class EmailMan extends SugarBean
{
    ...
    public function sendEmail(SugarPHPMailer $mail, $save_emails = 1, $testmode = false)
    {
        ...
        if (
            ...
            $text_only = false;
            // Header styling
            $mail->Body = "<div style='background:#f6f6f6;background-color:#f6f6f6;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f6f6f6;background-color:#f6f6f6;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#F6F6F6'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;font-size:0px;padding:0;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='vertical-align:top;padding:0;font-family:Arial,Helvetica,sans-serif' valign='top'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='font-size:0px;word-break:break-word;font-family:Arial,Helvetica,sans-serif'><div style='background:#5d21d1;margin-bottom: 20px;height: 100px;line-height:40px;font-family:Arial,Helvetica,sans-serif'>
            <table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='width:100%;font-family:Arial,Helvetica,sans-serif'>
            <tbody><tr style='font-family:Arial,Helvetica,sans-serif'>
                <td style='width:72px;vertical-align:top;font-family:Arial,Helvetica,sans-serif' valign='top' width='72'>
                    <p style='width:100px;height:100px;margin: 0 auto;font-family:Arial,Helvetica,sans-serif'>
                        <img alt='company-logo' height='auto' src='https://crm.pod-dev.com/legacy/themes/default/images/company_logo_white.png' style='padding: 33px 0;border:0;vertical-align:middle;outline:none;text-decoration:none;height:auto;width:99.5%;font-size:0;font-family:Arial,Helvetica,sans-serif' width='72' class='CToWUd' data-bit='iit'>
                    </p>
                </td>
            </tr>
        </tbody></table>
            ...
            if ($text_only) {
                ...
                $mail->IsHTML(false);
                $mail->Body .= "<div style='box-sizing: border-box !important;background:#fafafa;background-color:#fafafa;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#fafafa;background-color:#fafafa;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#fafafa'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;font-size:0px;padding:0;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='vertical-align:top;padding:0;font-family:Arial,Helvetica,sans-serif' valign='top'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='font-size:0px;word-break:break-word;font-family:Arial,Helvetica,sans-serif;box-sizing: border-box !important;'><style>.mozaik-inner{box-sizing: border-box; width: 100% !important}</style>" . $template_data['body'] . "</td></tr></tbody></table></td></tr></tbody></table></div></td></tr></tbody></table></div>";
            } else {
                $mail->Body .= "<div style='box-sizing: border-box !important;background:#fafafa;background-color:#fafafa;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#fafafa;background-color:#fafafa;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#fafafa'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;font-size:0px;padding:0;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='vertical-align:top;padding:0;font-family:Arial,Helvetica,sans-serif' valign='top'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='font-size:0px;word-break:break-word;font-family:Arial,Helvetica,sans-serif;box-sizing: border-box !important;'><style>.mozaik-inner{box-sizing: border-box; width: 100% !important}</style>" . wordwrap($template_data['body_html'], 900) . "</td></tr></tbody></table></td></tr></tbody></table></div></td></tr></tbody></table></div>";
                ...
                if ($this->has_optout_links == false) {
                    $mail->Body .= "
                    <div style='background:#fafafa;background-color:#fafafa;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#fafafa;background-color:#fafafa;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#FaFaFa'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;font-size:0px;padding:0;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='vertical-align:top;padding:0;font-family:Arial,Helvetica,sans-serif' valign='top'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='font-size:0px;word-break:break-word;font-family:Arial,Helvetica,sans-serif'><div style='height:40px;line-height:40px;font-family:Arial,Helvetica,sans-serif'> </div></td></tr></tbody></table></td></tr></tbody></table></div></td></tr></tbody></table>                   
                  </div>
                  <div style='background:#f6f6f6;background-color:#f6f6f6;margin:0px auto;max-width:600px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f6f6f6;background-color:#f6f6f6;width:100%;font-family:Arial,Helvetica,sans-serif' width='100%' bgcolor='#f6f6f6'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;padding:16px 16px 12px;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div style='margin:0px auto;max-width:568px;font-family:Arial,Helvetica,sans-serif'><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;margin-bottom: 10px;font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='direction:ltr;padding:0;text-align:center;font-family:Arial,Helvetica,sans-serif' align='center'><div class='m_4526398173065959330mj-column-per-100' style='text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%' style='font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='vertical-align:middle;padding:0;font-family:Arial,Helvetica,sans-serif' valign='middle'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='font-family:Arial,Helvetica,sans-serif' width='100%'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td align='center' style='padding:0;word-break:break-word;font-family:Arial,Helvetica,sans-serif'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;font-family:Arial,Helvetica,sans-serif'><tbody style='font-family:Arial,Helvetica,sans-serif'><tr style='font-family:Arial,Helvetica,sans-serif'><td style='width:132px;font-family:Arial,Helvetica,sans-serif' width='132'><img alt='POD logo' height='32' src='https://ci5.googleusercontent.com/proxy/JZOoqJv3w7rTrkrQE_qG97Rt7aQMhtnroS6kcF116c1ZS2B9MenlhGXGjr6I_NgmpS9ENch3-NgecxXhetxWzPcZDuxGH2rEG_OdWb0kbd-N0bx-cClimYCzN8VI=s0-d-e1-ft#https://notification-dev-static.s3.amazonaws.com/Calyx/images/pod-logo.png' style='border:0;display:block;outline:none;text-decoration:none;height:32px;width:100%;font-size:0;font-family:Arial,Helvetica,sans-serif' width='132' class='CToWUd' data-bit='iit'></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></div></td></tr></tbody></table><font style='font-size:0.6em; color: #888; padding: 20px;'>{$mod_strings['TXT_REMOVE_ME']} <a href='" . $this->tracking_url . "index.php?entryPoint=removeme&identifier={$this->getTargetId()}'>{$mod_strings['TXT_REMOVE_ME_CLICK']}</a></font></div></td></tr></tbody></table></div>
                  ";
                }
